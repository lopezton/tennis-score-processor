...
public class AceStatisticInstruction implements StatisticInstruction<Stroke, SimpleCountStatistic> {
	...
	public void evaluate(Stroke stroke) {
		if (this.player.equals(stroke.getPlayer()) && StrokeType.FIRST_SERVE.equals(stroke.getStrokeType()) && stroke.isWinner()) {
			this.count++;
		}
	}
